...
add action=add-dst-to-address-list address-list=games address-list-timeout=\
    none-dynamic chain=prerouting comment=ml dst-address-list=!private-lokal \
...
add action=add-dst-to-address-list address-list=games address-list-timeout=\
    ...
    !private-lokal dst-port=7889,8081,18081,10012,17500 protocol=tcp \
    src-address-list=private-lokal
add action=add-dst-to-address-list address-list=games address-list-timeout=\
    none-dynamic chain=prerouting comment="pubg mobile" dst-address-list=\
    !private-lokal dst-port=8000,8011,8700,9030,10000-10300,17000,20000-20010 \
